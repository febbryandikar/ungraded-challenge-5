...
func (h *NewRegisterHandler) Register(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
...
func (h *NewRegisterHandler) Login(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
